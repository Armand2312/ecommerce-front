...
export default function ProductCard({ product }) {
    ...
    return (
        <div className="group relative">
            <div className="flex flex-col items-center rounded-md shadow-lg p-2 hover:scale-110 hover:shadow-2xl hover:bg-white bg-gray-100 transition-all">
                ...
                <div className="group-hover:flex space-x-3 bottom-0 hidden transition-all">
